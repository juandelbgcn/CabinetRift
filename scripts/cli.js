...
const contractABI = require("../artifacts/contracts/Cabinetrift.sol/Cabinetrift.json").abi;

program
    .name("cabinetrift-cli")
    .description("CLI tool for Cabinetrift smart contract")
    .version("1.0.0");
