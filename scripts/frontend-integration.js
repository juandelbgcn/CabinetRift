 ...
 * This file demonstrates how to integrate Cabinetrift with a web frontend
 */

// For React/Vue/Angular applications
export class CabinetriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CabinetriftClient(provider, contractAddress);
